...
// 사용자가 즐겨찾기 해놓은 웹툰 카드 생성
login_user["favorite"].forEach((currentWebtoonID) => {
  ...
  currentWebtoonCard.setAttribute("data-closable", "slide-out-up");
  ...
  if (isNaverWebtoon.length === 1) {
    ...
    <div class="card-section light-black-bg">\
      ...
      <div class="favorite-box">
        <button class="favorite large button radius yellow-font grey-bg" data-close>
          <i class="fa fa-star"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;즐겨찾기 해제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </button>
      </div>
    </div>`;
